#ifndef __UI__CONTROLLERS__EXITAREACREATORINPUTHANDLER_H_INCLUDED__
#define __UI__CONTROLLERS__EXITAREACREATORINPUTHANDLER_H_INCLUDED__
...
namespace ui {
	namespace controllers {
		 ...
		 */
		class ExitAreaCreatorInputHandler : public RenderAreaInputHandler {
		public:
			/**
			 * Crea una nueva instancia de ExitAreaCreatorInputHandler
		...
		private:
			game::design::elements::ExitArea *exitArea;
			game::design::ElementFactory &factory;
			game::design::ElementContainer &container;
		};
	}
