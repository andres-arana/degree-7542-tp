#ifndef __UI__CONTROLLERS__ROPECREATORINPUTHANDLER_H_INCLUDED__
#define __UI__CONTROLLERS__ROPECREATORINPUTHANDLER_H_INCLUDED__
...
namespace ui {
	namespace controllers {
		 ...
		 * la creacion de sogas en el area de diseño
		 */
		class RopeCreatorInputHandler : public RenderAreaInputHandler {
		public:
			/**
			 * Crea una nueva instancia de RopeCreatorInputHandler
		...
		private:
			game::design::elements::Rope *rope;
			game::design::ElementFactory &factory;
			game::design::ElementContainer &container;
		};
	}
